...
const Card = ({ characters }: Props) => {
  ...
  return (
    <div className="group py-2 ">
      <div className="overflow-hidden bg-white border border-gray-200 rounded-lg shadow md:flex-row hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-900  dark:hover:bg-gray-700 m-0 flex flex-col items-center max-h-full ">
        <ClipLoader
          color={"#000"}
          loading={loading}
